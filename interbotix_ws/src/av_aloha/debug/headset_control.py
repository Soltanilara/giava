...
## Was `from constants import REAL_DT`.  constants.py is sim-era (aloha.xml
## paths, SIM_TASK_CONFIGS) and now lives in archive/; this scalar was the
## only thing this file took from it.
REAL_DT = 0.02  # 50 Hz control period
import time
import os
